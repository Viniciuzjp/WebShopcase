  ...
  const produtos = [
    {
      ...
      estoque: 35,
      descricao:
        "Fone de ouvido sem fio com até 40 horas de bateria e carregamento rápido.",
    ...
    },
    {
      ...
      estoque: 50,
      descricao:
        "Mouse gamer RGB com sensor de alta precisão e 6 botões programáveis.",
    ...
    },
    {
      ...
      estoque: 20,
      descricao:
        "Teclado mecânico compacto com switches Outemu Blue e iluminação RGB.",
    ...
    },
    {
      ...
      estoque: 15,
      descricao:
        "Caixa de som portátil com som estéreo e resistência à água IPX7.",
    ...
    },
    {
      ...
      estoque: 10,
      descricao:
        "Monitor Full HD com taxa de atualização de 144Hz e painel IPS.",
    ...
    },
    {
      ...
      estoque: 25,
      descricao:
        "Headset leve e confortável com microfone giratório e drivers de 50mm.",
    ...
    },
    {
      ...
      estoque: 40,
      descricao:
        "Pulseira inteligente com tela AMOLED, monitoramento de saúde e bateria de longa duração.",
    ...
    },
    {
      ...
      estoque: 30,
      descricao:
        "Power bank compacto com carregamento rápido e proteção contra sobrecarga.",
          ...
          <div className="flex flex-col gap-5">
            <ul>
              <li className="flex flex-col gap-5">
                <Button variant="primary" onClick={handleFilterAll}>
                  Mostrar Todos
                </Button>
                <Button variant="secondary" onClick={handleFilter}>
                  Preço: Maior para Menor
                </Button>
